...
public:
  ...
  void ClearPlaybackQueues(); // 清空播放队列（用于 Barge-in 打断）
  void SetBargeInContextMode(
      bool in_conversation); // 设置 Barge-in 上下文模式（对话中/非对话中）
  void SetInputMute(bool mute) { input_muted_ = mute; }
