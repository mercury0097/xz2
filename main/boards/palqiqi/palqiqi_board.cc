...
extern void InitializePalqiqiController();

class PalqiqiBoard : public WifiBoard {
private:
    LcdDisplay* display_;
    ...
    void InitializePalqiqiController() {
        ESP_LOGI(TAG, "初始化Palqiqi机器人MCP控制器");
        ::InitializePalqiqiController();
    }

public:
    PalqiqiBoard() : boot_button_(BOOT_BUTTON_GPIO) {
        InitializeSpi();
